                        ...
                        <div class="col">
                            <div class="card h-100 border-0 rounded-3 shadow">
                                <div class="card-body text-center">
                                    ...
                                    <!-- Ubah tautan ke route user/tagihans/index -->
                                    <a href="{{ route('usertagihans.index') }}" class="btn btn-primary">Lihat</a>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card h-100 border-0 rounded-3 shadow">
                                <div class="card-body text-center">
                                    ...
                                    <a href="{{ route('pembayarans.create') }}" class="btn btn-primary">Lihat</a>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card h-100 border-0 rounded-3 shadow">
                                <div class="card-body text-center">
                                    ...
                                    <a href="{{ route('userpembayarans.perbulan') }}" class="btn btn-primary">Lihat</a>
                                </div>
                            </div>
                        </div>
                        <div class="col">
