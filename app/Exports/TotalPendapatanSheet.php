...
class TotalPendapatanSheet implements FromCollection, WithTitle, WithHeadings, WithStyles, WithColumnWidths, WithEvents
{
    protected $totalPendapatan;

    public function __construct($totalPendapatan)
    {
    ...
    {
        return [
            ['Total Pendapatan'], // Judul tabel
            ['Keterangan', 'Jumlah (Rp)'], // Judul kolom
        ];
    }
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->setCellValue('A1', 'Total Pendapatan');
