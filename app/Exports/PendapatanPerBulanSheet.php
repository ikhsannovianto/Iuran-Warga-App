...
class PendapatanPerBulanSheet implements FromCollection, WithTitle, WithHeadings, WithStyles, WithColumnWidths, WithEvents
{
    protected $pendapatanPerBulan;

    public function __construct($pendapatanPerBulan)
    {
    ...
    {
        return collect($this->pendapatanPerBulan);
    }
    ...
    {
        return [
            ['Pendapatan per Bulan'], // Judul tabel
            ['Bulan', 'Total Pendapatan (Rp)'], // Judul kolom
        ];
    }
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->setCellValue('A1', 'Pendapatan per Bulan');
